...
class Frame(wx.Frame):
    ...
    #----------------------------------------------------------------------
    def __init__(self, parent, id, title, mplayer,score):
        ...
        # dp = DrawPanel(None,wx.ID_ANY,"Media Player",score)
        # mainSizer.Add(dp,1,wx.ALL|wx.EXPAND, 5)
...
def startPlayer(score):
    app = wx.App(False)
    mplayer_path = os.path.join(dirName, "mplayer/mplayer.exe")
    frame = Frame(None,wx.ID_ANY,"Media Player",mplayer_path,score)
    frame.Show()
    app.MainLoop()